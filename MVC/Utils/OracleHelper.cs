...
namespace MVC.Utils{
    ...
    public abstract class OracleHelper {
        ...
        public static readonly string ConnectionString = ConfigurationManager.ConnectionStrings["OraConnString"].ConnectionString;
        ...
        public static long GetSequence(OracleConnection conn,string tableName)
        {
            long id;
            string sql = "SELECT VALUE FROM SEQ_TABLE WHERE KEY=:KEY FOR UPDATE";
            OracleParameter[] parms = new OracleParameter[] {
                    new OracleParameter("KEY", tableName) };
            ...
            if (obj != null)
            {
                ...
                OracleParameter[] parmsUpdate = new OracleParameter[] {
                new OracleParameter("NEW_ID", id+1),
                new OracleParameter("OLD_ID", id),
                new OracleParameter("KEY", tableName) };
            ...
            else
            {
                ...
                OracleParameter[] parmsInsert = new OracleParameter[] {
                new OracleParameter("KEY", tableName),
                new OracleParameter("VALUE", id+1) };
